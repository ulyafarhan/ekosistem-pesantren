    ...
    <div class="pt-24 pb-20 sm:pt-32 sm:pb-24">
        <div class="container mx-auto px-6 max-w-7xl">
            ...
            <div class="space-y-16">
                <!--[if BLOCK]><![endif]--><?php if($sejarahSmp): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($sejarahSma): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if(!$sejarahSmp && !$sejarahSma): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\laragon\www\ekosistem-pesantren\resources\views/livewire/sejarah-pendidikan-page.blade.php ENDPATH**/ ?>