...
<div x-data="{ showBrosur: false }">
    ...
    <?php if($heroSliders->isNotEmpty()): ?>
        <section class="relative bg-white pt-1 mt-[-100px]"
                x-data="{ activeSlide: 1, slideCount: <?php echo e(count($heroSliders)); ?> }"
                x-init="
                    if (slideCount > 1) {
            ...
            <div class="container mx-auto px-6 lg:px-8 relative">
                <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-16 items-center pt-24 pb-28 sm:pt-32 sm:pb-32"> 
                    ...
                    <div class="relative w-full max-w-lg mx-auto lg:max-w-none h-[300px] sm:h-[400px] lg:h-[550px] mt-16 lg:mt-0 lg:order-2">
                        <?php $__currentLoopData = $heroSliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <div x-show="activeSlide === <?php echo e($index + 1); ?>"
                                ...
                                style="background-image: url('<?php echo e($heroImage); ?>')" x-cloak>
                            </div>
                        ...
                        <?php if(count($heroSliders) > 1): ?>
                            <div class="absolute bottom-12 left-1/2 -translate-x-1/2 z-10 flex space-x-3">
                                <?php $__currentLoopData = $heroSliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button @click="activeSlide = <?php echo e($index + 1); ?>"
                                            :class="activeSlide === <?php echo e($index + 1); ?> ? 'bg-primary-blue scale-125' : 'bg-gray-300'"
