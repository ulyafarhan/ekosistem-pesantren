...
>
    <nav class="container mx-auto px-6 py-4 max-w-7xl">
        <div class="flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center gap-x-8 text-gray-600 font-semibold">
                <a href="<?php echo e(route('homepage')); ?>" class="hover:text-primary-blue transition-colors <?php if(request()->routeIs('homepage')): ?> active-nav-link <?php endif; ?>">Home</a>
                <a href="<?php echo e(route('program.index')); ?>" class="hover:text-primary-blue transition-colors <?php if(request()->routeIs('program.index')): ?> active-nav-link <?php endif; ?>">Program</a>
                <a href="<?php echo e(route('berita.index')); ?>" class="hover:text-primary-blue transition-colors <?php if(request()->routeIs('berita.*')): ?> active-nav-link <?php endif; ?>">Berita</a>
                <a href="<?php echo e(route('galeri.index')); ?>" class="hover:text-primary-blue transition-colors <?php if(request()->routeIs('galeri.index')): ?> active-nav-link <?php endif; ?>">Galeri</a>
                ...
                <div class="relative" 
                    ...
                    <button 
                        ...
                        <?php if(request()->routeIs('pengurus.index') || request()->routeIs('tokoh.sejarah.index')): ?> active-nav-link <?php endif; ?>"
                    >
                    ...
                    >
                        ...
                        <a href="<?php echo e(route('tokoh.sejarah.index')); ?>" 
                        class="block px-5 py-3 text-gray-700 hover:bg-primary-blue/10 hover:text-primary-blue transition-colors">
                        Tokoh Sejarah
                        </a>
                    </div>
    ...
    <div x-show="mobileMenuOpen" x-cloak x-transition class="lg:hidden mt-4 space-y-2">
        ...
        <?php if(request()->routeIs('homepage')): ?> bg-gray-100 text-primary-blue 
        <?php else: ?> hover:bg-gray-100 <?php endif; ?>">
        Home
        </a>
        ...
        @click="mobileMenuOpen = false"
        class="block px-4 py-2 rounded-md font-semibold 
        <?php if(request()->routeIs('program.index')): ?> bg-gray-100 text-primary-blue 
        <?php else: ?> hover:bg-gray-100 <?php endif; ?>">
        Program
        </a>
        ...
        @click="mobileMenuOpen = false"
        class="block px-4 py-2 rounded-md font-semibold 
        <?php if(request()->routeIs('berita.*')): ?> bg-gray-100 text-primary-blue 
        <?php else: ?> hover:bg-gray-100 <?php endif; ?>">
        Berita
        </a>
        ...
        @click="mobileMenuOpen = false"
        class="block px-4 py-2 rounded-md font-semibold 
        <?php if(request()->routeIs('galeri.index')): ?> bg-gray-100 text-primary-blue 
        <?php else: ?> hover:bg-gray-100 <?php endif; ?>">
        Galeri
        </a>
...
<?php /**PATH C:\laragon\www\ekosistem-pesantren\resources\views/layouts/header.blade.php ENDPATH**/ ?>