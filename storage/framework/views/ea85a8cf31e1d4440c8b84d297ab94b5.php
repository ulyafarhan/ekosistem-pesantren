<header x-data="{ mobileMenuOpen: false, aboutDropdownOpen: false }"
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center gap-x-8 text-gray-600 font-semibold">
                <a href="<?php echo e(route('homepage')); ?>" wire:navigate
                    class="hover:text-primary-blue transition-colors <?php if($isHome): ?> active-nav-link <?php endif; ?>">Home</a>
                <a href="<?php echo e(route('program.index')); ?>" wire:navigate
                    class="hover:text-primary-blue transition-colors <?php if($isProgram): ?> active-nav-link <?php endif; ?>">Program</a>
                <a href="<?php echo e(route('berita.index')); ?>" wire:navigate
                    class="hover:text-primary-blue transition-colors <?php if($isBerita): ?> active-nav-link <?php endif; ?>">Berita</a>
                <a href="<?php echo e(route('galeri.index')); ?>" wire:navigate
                    class="hover:text-primary-blue transition-colors <?php if($isGaleri): ?> active-nav-link <?php endif; ?>">Galeri</a>
                
                <div @mouseenter="aboutDropdownOpen = true" @mouseleave="aboutDropdownOpen = false" class="relative">
                    <button class="flex items-center gap-1 hover:text-primary-blue transition-colors <?php if($isTentang): ?> active-nav-link <?php endif; ?>">
                        Tentang Kami
    ...
    <div x-show="mobileMenuOpen" x-cloak class="lg:hidden"
        ...
        <div class="p-6 space-y-3 border-t border-gray-200/80">
            <a href="<?php echo e(route('homepage')); ?>" wire:navigate @click="mobileMenuOpen = false"
                class="block px-4 py-2 rounded-md font-semibold hover:bg-gray-100">Home</a>
            <a href="<?php echo e(route('program.index')); ?>" wire:navigate @click="mobileMenuOpen = false"
                class="block px-4 py-2 rounded-md font-semibold hover:bg-gray-100">Program</a>
            <a href="<?php echo e(route('berita.index')); ?>" wire:navigate @click="mobileMenuOpen = false"
                class="block px-4 py-2 rounded-md font-semibold hover:bg-gray-100">Berita</a>
            <a href="<?php echo e(route('galeri.index')); ?>" wire:navigate @click="mobileMenuOpen = false"
            ...
            <div x-data="{ aboutMobileOpen: false }">
                ...
                <div x-show="aboutMobileOpen" x-cloak class="pl-6 mt-2 space-y-2">
                    <a href="<?php echo e(route('pengurus.index')); ?>" wire:navigate @click="mobileMenuOpen = false"
                        class="block px-4 py-2 rounded-md font-semibold hover:bg-gray-100">Struktur Pengurus</a>
                    <a href="<?php echo e(route('tokoh.sejarah.index')); ?>" wire:navigate @click="mobileMenuOpen = false"
