...
<?php $__env->startSection('title', 'Jejak Sejarah Unit Pendidikan - Pesantren Pusat'); ?>
<?php $__env->startSection('description', 'Telusuri tonggak sejarah berdirinya unit pendidikan SMP dan SMA di Pesantren Pusat, sebuah perjalanan visi dan dedikasi.'); ?>
        ...
        <div class="space-y-16">
            ...
            <section id="sejarah-smp" class="bg-white p-8 md:p-12 rounded-2xl border border-gray-200/80 shadow-lg animasi-scroll fade-in-up">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                    ...
                    <div class="lg:col-span-2 prose max-w-none prose-lg text-gray-600 leading-relaxed">
                        <?php echo $__env->make('partials._render_content', ['contentJson' => $sejarahSmp->sejarah_smp], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </section>
            <?php endif; ?>
            ...
            <section id="sejarah-sma" class="bg-white p-8 md:p-12 rounded-2xl border border-gray-200/80 shadow-lg animasi-scroll fade-in-up">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                    ...
                    <div class="lg:col-span-2 prose max-w-none prose-lg text-gray-600 leading-relaxed">
                        <?php echo $__env->make('partials._render_content', ['contentJson' => $sejarahSma->sejarah_sma], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </section>
            <?php endif; ?>

            <?php if(!$sejarahSmp && !$sejarahSma): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ekosistem-pesantren\resources\views/sejarah/index.blade.php ENDPATH**/ ?>