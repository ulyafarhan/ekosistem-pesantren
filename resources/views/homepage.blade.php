...
@section('title', 'Pesantren Pusat - Membentuk Pemimpin Masa Depan Berakhlak Qur\'ani')
@section('description', 'Selamat datang di Pesantren Pusat, institusi pendidikan Islam terdepan yang berdedikasi untuk mencetak generasi pemimpin yang berintegritas, cerdas, dan berlandaskan Al-Qur\'an.')
...
<div x-data="{ showBrosur: false }">
    ...
    <section class="relative bg-white pt-1 mt-[-100px]">
        <div class="container mx-auto px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-16 items-center pt-24 pb-20 sm:pt-32 sm:pb-24">
                ...
                {{-- Gambar sekarang diletakkan kedua di HTML --}}
                    ...
                    @foreach ($statistics as $stat)
                        <div class="bg-white p-6 rounded-2xl border border-gray-200/80 text-center shadow-sm">
                            <span class="text-4xl font-extrabold text-primary-blue stat-number" 
                                  ...
                                  data-final-display="{{ $stat['display'] }}">
                                0
                            </span>
                            <p class="mt-2 font-semibold text-gray-600">{{ $stat['label'] }}</p>
                        </div>
                    @endforeach
                </div>
            </div>
    ...
    <div class="container mx-auto px-6 lg:px-8 max-w-7xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="{{ route('berita.show', $berita) }}" class="block group bg-white rounded-xl border border-gray-200/80 overflow-hidden hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 animasi-scroll fade-in-up" style="transition-delay: {{ $index * 150 }}ms;">
