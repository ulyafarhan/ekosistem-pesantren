<footer id="kontak" class="bg-gray-900 text-gray-300">
    <div class="container mx-auto px-6 py-16 max-w-7xl">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-3">
                    ...
                    <li><a href="{{ route('galeri.index') }}" class="hover:text-white transition-colors">Galeri</a></li>
                </ul>
            </div>
             <div>
                <h3 class="font-semibold text-white tracking-wider">Tentang Kami</h3>
                <ul class="mt-4 space-y-3">
                    <li><a href="{{ route('tokoh.sejarah.index') }}" class="hover:text-white transition-colors">Sejarah</a></li>
                    <li><a href="{{ route('pengurus.index') }}" class="hover:text-white transition-colors">Struktur Pengurus</a></li>
                </ul>
            </div>
            <div>
        ...
        <div class="mt-16 border-t border-gray-700 pt-8 text-center text-gray-500">
            <p>&copy; {{ date('Y') }} Pesantren Pusat. Semua Hak Cipta Dilindungi.</p>
        </div>
    </div>
</footer>